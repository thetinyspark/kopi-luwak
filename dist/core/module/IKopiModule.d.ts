...
/**
 * Configuration type for a KopiModule
...
/**
 * Interface for KopiModule implementation
 * Defines the contract for module configuration and loading
 * @interface IKopiModule
 */
export default interface IKopiModule {
    /**
