...
export { ICommand, ICommandFactoryMethod, Container, IMediator, IProxy, IModel, IService, IStoreModel, Model, Proxy, StoreModel, Mediator, Facade, KopiModule, IKopiModule, Injectable, RegisterCommand, RegisterProxy, RegisterMediator, resolve, rootContainer, rootFacade };
